...
import 'package:flutter/material.dart'; // Import Material package for BuildContext
  ...
  static Future<void> signInWithGoogle(BuildContext context) async {
    try {
      ...
      if (user != null) {
        ...
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => UploadDriverFilesScreen()));
      }
    } catch (e) {
